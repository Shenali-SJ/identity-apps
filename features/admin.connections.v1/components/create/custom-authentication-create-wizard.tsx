...
export const CustomAuthenticationCreateWizard: FC<CustomAuthenticationCreateWizardProps> = (
    ...
    // TODO: [Immediate] set the selection card -> image container height to be 100px
    const wizardCommonFirstPage = () => (
        ...
        >
            <div className="sub-template-selection">
                ...
                <div style={ { display: "flex", justifyContent: "space-between", marginTop: "10px", columnGap:"20px" } }>
                {/* <div className="selection-card-container"> */}
                    <SelectionCard
                        style={ { flex: 1, height: "260px", marginTop: "auto", whiteSpace: "normal" } }
                        centered={ true }
                        image={
                        ...
                        header={ (<div style= { { whiteSpace: "normal", fontWeight: "bold", margin: "20px" } }>
                                    External (Federated) User Authentication
                        </div>) }
                        description={
                            (<div style={ { display: "flex", flexDirection: "column", justifyContent: "space-between", whiteSpace: "normal" } }>
                                <p style={ { marginBottom: "15px" } } >Authenticate and provision federated users.</p>
                    ...
                    <SelectionCard
                        ...
                        description={
                            (<div style={ { display: "flex", flexDirection: "column", justifyContent: "space-between", whiteSpace: "normal" } }>
                                <p>Collect identifier and authenticate user accounts managed in the organization.</p>
                    ...
                    <SelectionCard
                        ...
                        className="sub-template-selection-card"
                        header={ (<div style= { { whiteSpace: "normal", fontWeight: "bold" } }>
                            2FA Authentication
                        </div>) }
                        description={
                            (<div style={ { whiteSpace: "normal" } }>
                                <p>Only verify users in a second or later step in the login flow.</p>
                                <p>Eg: TOTP</p>
                            </div>)
                        }
